...
<head>
	<meta charset="utf-8">
	<title>How to integrate paypal payment in Laravel - MARTIN WAINAINA</title>
...
<body>
    ...
    <div class="row">    	
        <div class="col-md-8 col-md-offset-2">        	
        	<h3 class="text-center" style="margin-top: 90px;">How to integrate paypal payment in Laravel - MARTIN WAINAINA</h3>
